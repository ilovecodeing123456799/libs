local Lowfi = {
    Boxes = false,
    BoxesColor = Color3.fromRGB(18, 42, 130),
    Names = false,
    NamesColor = Color3.fromRGB(18, 42, 130),
    Distance = false,
    DistanceColor = Color3.fromRGB(18, 42, 130),
    Cham = false,
    ChamColor1 = Color3.fromRGB(18, 42, 130),
    ChamColor2 = Color3.fromRGB(18, 42, 130),
    Thickness = 1,
